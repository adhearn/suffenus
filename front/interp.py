...
Please don't judge me for this code. I was challenging myself to write this in 30 minutes, and it shows.
"""
...
def tac_eval(f):
    ...
    while next_index < len(processed_statements):
        ...
        if stmt_op == JUMP_TOKEN:
            ...
            continue
        elif stmt_op == IF_TOKEN:
            arg1 = env_lookup(env, stmt_parts[1])
            arg2 = env_lookup(env, stmt_parts[3])
            op = stmt_parts[2]
            jump_label = stmt_parts[5]
            if apply_relop(op, arg1, arg2):
                next_index = label_indexes[jump_label]
            else:
                next_index += 1
            continue
        else:  # BINOP or COPY
