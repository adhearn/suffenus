...
void statement_assign_build_symbol_table(struct Statement_assignment* statement_assignment, struct SymbolTable *st);
void statement_return_build_symbol_table(struct Statement_return* statement_return, struct SymbolTable *st);
